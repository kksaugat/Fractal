...
public class MainTest {
		...
		assertEquals(3,coordinates);// should return 1 if escape time for a coordinate whose distance from the origin  exceeds the escape distance
		}
	...
	@Test
		...
		assertEquals(69,coordinates); // should return 255 if escape time for a coordinate whose distance from the origin never exceeds the escape distance
		}
